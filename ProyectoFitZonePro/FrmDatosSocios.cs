...
namespace ProyectoFitZonePro
{
    public partial class FrmDatosSocios : Form
    {
        ...
        private void FrmDatosSocios_Load(object sender, EventArgs e)
        {
            ...
            GraphicsPath rutaBoton2 = CrearRutaRedondeada(new Rectangle(0, 0, BtnSeleccionarMembresia.Width, BtnSeleccionarMembresia.Height), radioBorde);

            BtnAceptar.Region = new Region(rutaBoton1);
            BtnCancelar.Region = new Region(rutaBoton1);
            BtnSeleccionarMembresia.Region = new Region(rutaBoton2);
            BtnSeleccionarUsuario.Region = new Region(rutaBoton2);
        }
